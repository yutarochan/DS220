...
DROP TABLE IF EXISTS `a2q_25`;
DROP TABLE IF EXISTS `a2q_50`;
DROP TABLE IF EXISTS `a2q_75`;
DROP TABLE IF EXISTS `c2a_25`;
DROP TABLE IF EXISTS `c2a_50`;
DROP TABLE IF EXISTS `c2a_75`;
DROP TABLE IF EXISTS `c2q_25`;
DROP TABLE IF EXISTS `c2q_50`;
DROP TABLE IF EXISTS `c2q_75`;
